...
@Service
public class OrderFulfilService extends CrudService<OrderFulfil, Long> implements InitializingBean {
    private final OrderFulfilDao orderFulfilDao;

    @Override
    public void afterPropertiesSet() throws Exception {
        ContainerConstants.CRUD_SERVICE_MAP.put(CrudServiceTyp.ORDER_FULFIL.getValue(), this);
    }
}
